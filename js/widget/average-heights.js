...
AverageHeightsWidget.percentiles = [
  {
    name: "in the 0.0000000001th percentile (1 in a trillion)",
    value: 0.000000000001,
  },
  {
    name: "in the 0.000000001th percentile (1 in 100 billion)",
    value: 0.00000000001,
  },
  {
    name: "in the 0.00000001th percentile (1 in 10 billion)",
    value: 0.0000000001,
  },
  {
    name: "in the 0.0000001th percentile (1 in a billion)",
    value: 0.000000001,
  },
  {
    name: "in the 0.000001th percentile (1 in 100 million)",
    value: 0.00000001,
  },
  ...
  {
    name: "in the 99.999999th percentile (1 in 100 million)",
    value: 0.99999999,
  },
  {
    name: "in the 99.9999999th percentile (1 in a billion)",
    value: 0.999999999,
  },
  {
    name: "in the 99.99999999th percentile (1 in 10 billion)",
    value: 0.9999999999,
  },
  {
    name: "in the 99.999999999th percentile (1 in 100 billion)",
    value: 0.99999999999,
  },
  {
    name: "in the 99.9999999999th percentile (1 in trillion)",
...
AverageHeightsWidget.selectedPercentile =
  AverageHeightsWidget.defaultPercentile;

$(() => {
  $("#average-heights-widget .close").on("click", () => {
    AverageHeightsWidget.close();
  });
  $("#average-heights-widget .apply").on("click", () => {
    AverageHeightsWidget.apply();
  });
  $("#average-heights-widget .gender .carousel-left").on("click", () => {
    AverageHeightsWidget.prevGender();
  });
  $("#average-heights-widget .gender .carousel-right").on("click", () => {
    AverageHeightsWidget.nextGender();
  });
  $("#average-heights-widget .age .carousel-left").on("click", () => {
    AverageHeightsWidget.prevAge();
  });
  $("#average-heights-widget .age .carousel-right").on("click", () => {
    AverageHeightsWidget.nextAge();
  });
  $("#average-heights-widget .percentile .carousel-left").on("click", () => {
    AverageHeightsWidget.prevPercentile();
  });
  $("#average-heights-widget .percentile .carousel-right").on("click", () => {
...
AverageHeightsWidget.updateData = () => {
  let gender =
    AverageHeightsWidget.genders[AverageHeightsWidget.selectedGender];
  let age = AverageHeightsWidget.ages[AverageHeightsWidget.selectedAge];
  let percentile =
    AverageHeightsWidget.percentiles[AverageHeightsWidget.selectedPercentile];

  $("#average-heights-widget .gender p").text(
    age.isYoung ? gender.nameYoung : gender.name
  );
  ...
  $("#average-heights-widget .result-height").text(
    Height.displayString(height)
  );
};
...
AverageHeightsWidget.nextGender = () => {
  ...
  if (
    AverageHeightsWidget.selectedGender >= AverageHeightsWidget.genders.length
  ) {
...
AverageHeightsWidget.prevGender = () => {
  ...
  if (AverageHeightsWidget.selectedGender < 0) {
    AverageHeightsWidget.selectedGender =
      AverageHeightsWidget.genders.length - 1;
  }
  AverageHeightsWidget.updateData();
};
AverageHeightsWidget.nextAge = () => {
...
AverageHeightsWidget.nextPercentile = () => {
  ...
  if (
    AverageHeightsWidget.selectedPercentile >=
    AverageHeightsWidget.percentiles.length
  ) {
...
AverageHeightsWidget.prevPercentile = () => {
  ...
  if (AverageHeightsWidget.selectedPercentile < 0) {
    AverageHeightsWidget.selectedPercentile =
      AverageHeightsWidget.percentiles.length - 1;
  }
  AverageHeightsWidget.updateData();
};
