...
Graphics.getSrc = (graphic) => {
  ...
  if (graphic === "f1_md") {
    return "img/f1-md.png";
  }
  if (graphic === "f1_lg") {
    return "img/f1-lg.png";
  }
  if (graphic === "f1_xl") {
    return "img/f1-xl.png";
  }
  if (graphic === "fs1_md") {
    return "img/fs1-md.png";
  }
  if (graphic === "fs1_lg") {
    return "img/fs1-lg.png";
  }
  if (graphic === "fs1_xl") {
    return "img/fs1-xl.png";
  }
};
...
Graphics.getHeelsPositions = (graphic) => {
  ...
  if (graphic === "fs1_md" || graphic === "fs1_lg" || graphic === "fs1_xl") {
    return [{ x1: 0.03, x2: 0.82 }];
  }
